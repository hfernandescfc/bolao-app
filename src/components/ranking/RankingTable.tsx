      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-green-800 hover:bg-green-800">
            ...
            <TableHead className="text-white text-center w-16">Pts</TableHead>
            <TableHead className="text-white text-center w-12 hidden sm:table-cell">Exatos</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {entries.length === 0 && (
              ...
              >
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <span className="text-sm">{entry.profile?.display_name ?? 'Participante'}</span>
                    {isMe && (
